  ...
  return (
        <div className=" hero min-h-screen z-0" >
          <div className="hero-overlay bg-opacity-30  text-center object-cover" style={{backgroundPosition: "center",backgroundSize:"cover",backgroundImage: `url(${urlFor(banner).url()})` }}></div>
              <div className="w-3/4 md:w-full flex justify-center items-center  text-left text-neutral-content backdrop-blur-sm bg-whitesmoke-100/20 rounded-lg">
                    <div className="max-w-3xl text-left py-4 px-10">
                      <div className="flex flex-col gap-1">
                        <h1 className="mb-5 text-[54px] font-bold font-poppins uppercase md:text-[40px]  text-gray-black">{title}</h1>
                        <p className="mb-5 font-poppins fontse text-[24px] md:text-[20px] bg-gradient-to-r from-blue-950 to-black inline-block text-transparent bg-clip-text">{desc}</p>  
                      </div>
