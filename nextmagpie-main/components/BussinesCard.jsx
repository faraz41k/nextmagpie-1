...
const BussinesCard = ({
  ...
  return (
    <Link href={href} 
      ...
      style={card11Style}
    >
      <div className="my-0 mx-[!important] absolute top-[18px]  left-[16px] flex flex-col items-start justify-start gap-[11px] z-[0]">
        <div className="relative leading-[32px] font-semibold text-[14px] backdrop-blur-sm bg-whitesmoke-200/20 p-2">{cityName}</div>
