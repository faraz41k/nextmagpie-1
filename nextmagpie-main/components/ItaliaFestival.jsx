    ...
    <div className='max-w-full col-span-4 lg:xlg:order-2 '>
        ...
        <div  className='  flex flex-col items-start justify-center pt-8 lg:xlg:pt-28 gap-[100px] pb-8' >
            <div className='px-[60px] max-w-6xl'>
                ...
                tre valli di Rumbur, Brumbret e Birir. Questa comunità minoritaria conta solamente 4000 abitanti. Gli studiosi
                ...
                <ul className='gap-2 flex flex-col pt-6 pl-2 pb-6'>
                    ...
                    abiti nuovi, le donne si adornano e le ragazze danzano e cantano sulle colline. Le case vengono addobbate
                    ...
                    Uchal Festival (20-21 agosto): Questa festa celebra il raccolto. Le persone indossano abiti tradizionali,
                    cantano, ballano e ringraziano la natura per aver donato orzo e grano. Vengono preparati cibi speciali come
                    formaggio, latticello e pane di mais.
                    </li>
                    <li className='text-gray-black font-poppins font-semibold'>
                    Chaumas Festival (15-22 dicembre): È il più grande festival Kalash, che si tiene per due settimane intorno
                    al solstizio d'inverno, segnando la fine dell'anno agricolo con musica, danze e sacrifici di capre. Questo
                    evento è dedicato al dio Balimain, che proviene dalla mitica patria dei Kalash. Per onorare i loro antenati, si
                    svolgono rituali speciali in cui i ragazzi impersonano gli antichi. La cerimonia principale si tiene presso un
                    albero speciale chiamato Indrunkot, legato a Indr, il dio delle mucche e fratello di Balimain.
                    </li>

                </ul>

                <p className='font-poppins'> Questo itinerario vi condurrà da Islamabad a Chitral, attraverso un suggestivo viaggio panoramico nella valle
                    dello Swat. Vi immergerete in due giorni di festeggiamenti nella valle dei Kalash, vivendo esperienze
                    indimenticabili della loro cultura. Seguirà un incantevole e avventuroso viaggio in auto verso Mastuj e il lago
                    Khalti, dove potrete ammirare fiumi scintillanti e gustare trote di montagna fresche. La strada proseguirà verso
                    la mozzafiata valle di Hunza, dove avrete l'opportunità di esplorare i storici forti di Baltit e Altit, ammirare le
                    acque color smeraldo del lago Attabad e i maestosi coni di Passu. Godetevi una giornata rilassante dedicata allo
                    shopping di souvenir nei vicoli di Karimabad, prima di concludere con una cena speciale a 2700 metri di
                    altitudine presso il punto panoramico di Duikar. Il viaggio terminerà a Islamabad, dove potrete esplorare la città,
            ...
            <div className='px-[60px] flex flex-col flex-wrap max-w-6xl' id='Itinery'>
                ...
                <h3 className='text-[24px] font-light underline  pb-3 font-poppins'>Itinerario di 14 giorni: Chilum Joshi Festival di Kalash (festa di primavera, 13-16
                    maggio)</h3>
                <div className='list-none'>
                    <ul className='list-none'>
                      ...
                      <li   className='font-poppins text-[30px]  md:text-[20px] '>Giorno 4: 1° giorno di festival (30 km, 1 ora e 30 minuti), pernottamento nella valle di Kalash </li>
                      <li   className='font-poppins text-[30px]  md:text-[20px] '>Giorno 5: 2° giorno di festival (30 km, 1 ora e 30 minuti), pernottamento nella valle di Kalash </li>
                      <li   className='font-poppins text-[30px]  md:text-[20px] '>Giorno 6: trasferimento a Mastuj (145 km, 5 ore)</li>
                      <li   className='font-poppins text-[30px]  md:text-[20px] '>Giorno 7: viaggio al lago Khalti (140 km, 4 ore e 30 minuti)</li>
                      <li   className='font-poppins text-[30px]  md:text-[20px] '>Giorno 8: viaggio panoramico in auto tra fiumi e montagne (210 km, 5 ore) fino alla Valle di Hunza </li>
                      ...
                      <li   className='font-poppins text-[30px]  md:text-[20px] '>Giorno 11: giornata di relax, acquisto di souvenir, esperienza del tramonto e cena speciale a 2700 metri. </li>
            ...
            <div className='px-[60px] flex flex-col flex-wrap max-w-6xl' id='Itinery'>
                ...
                <h3 className='text-[24px] font-light underline  pb-3 font-poppins'>Itinerario di 14 giorni: Uchal Festival (festival estivo, 20-22 agosto)</h3>
                <div className='list-none'>
                ...
                <ul className='list-none'>
                      ...
                      di Kalash </li>
                      <li   className='font-poppins text-[30px] md:text-[20px]'>Giorno 5: 2° giorno di festival (30 km, 1 ora e 30 minuti), pernottamento nella valle
                      di Kalash </li>
                      <li   className='font-poppins text-[30px] md:text-[20px]'>Giorno 6: trasferimento a Mastuj (145 km, 5 ore) </li>
                      <li   className='font-poppins text-[30px] md:text-[20px]'>Giorno 7: viaggio al lago Khalti (140 km, 4 ore e 30 minuti) </li>
