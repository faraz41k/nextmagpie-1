...
const PageHero = ({name ,sliderImages,  banner}) => {
  ...
  return (
    <>
      <div className="hero min-h-[550px] sm:h-[350px] w-full bg-cover relative self-stretch " style={{backgroundImage: `url(${urlFor(banner).fit('clip').url()})` , backgroundRepeat: 'no-repeat'}}>
