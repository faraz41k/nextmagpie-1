...
import { getCustomTours } from "@/sanity/sanity/sanity-utils";
...
const CustomTours = async ({params})=> {
  console.log(params);
 const data =await getCustomTours() 
  ...
  return (
    <div className=' self-stretch  flex flex-col mb-6'>
      {/* hero */}
      <div className=" ">
      <div className="hero min-h-[600px] w-full bg-cover bg-center relative" style={{backgroundImage: 'url(/tailoredBanner.jpg)'}}>
