...
import { getHeritageTours } from "@/sanity/sanity/sanity-utils";
...
const Heritage = async ()=> {
  
 const data =await getHeritageTours() 
  ...
  return (
    <div className=' self-stretch  flex flex-col mb-6'>
      {/* hero */}
      <div className=" ">
      <div className="hero min-h-[600px] w-full bg-cover bg-center relative" style={{backgroundImage: 'url(/trek.jpg)'}}>
        <div className="hero-overlay  bg-opacity-60 py-5"></div>
          ...
          <div className="max-w-md ">
              <div className="min-w-[400px] mx-auto  flex flex-col justify-center items-center py-16  text-center">
                ...
                <p className="font-poppins text-[20px]">Book a Magpie Tours adventure to Pakistans UNESCO World Heritage sites, featuring guided cultural tours and historic landmarks.</p>
              </div>
