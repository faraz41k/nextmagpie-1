...
import { getDeosaiBar, getGemStoneSafari, getGemStoneTours, getSkiShopdinPass, getYogaRetreats,getCorporateRetreats } from '@/sanity/sanity/sanity-utils'


export const metadata = {
  title: 'Corporate retreats',
  description: "Plan your international corporate retreat to Northern Pakistan with Magpie Tours. Experience stunning landscapes, team-building activities, and seamless arrangements. Book your corporate getaway today!"
}
...
const  ProductDetail = async () => {
  ...
  const GemStoneSafari = await getCorporateRetreats()
