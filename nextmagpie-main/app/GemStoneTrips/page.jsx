...
import { getDeosaiBar, getGemStoneSafari, getGemStoneTours, getSkiShopdinPass } from '@/sanity/sanity/sanity-utils'

export const metadata = {
  title: 'Gemstone Trade Trip',
  description: "Join Magpie Tours for gemstone trade trips to Pakistan. Discover exquisite gems, explore local markets, and benefit from expert guidance. Book your gemstone trade adventure today!"
}



const  ProductDetail = async () => {
  const Product1 =await getGemStoneTours()
  const p1= Product1[0]
  ...
  const Product3 = await getGemStoneSafari()  
  const p3 = Product3[0]
  ...
  const GemStoneSafari = await getGemStoneTours()
