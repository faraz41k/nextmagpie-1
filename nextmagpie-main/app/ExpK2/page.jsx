...
import { getExpK2, getExpBroeadPeak, getExpKunyang,getExpKoranKoh } from '@/sanity/sanity/sanity-utils'

export const metadata = {
  title: 'K2 Peak Climbing Expedition',
  description: "Join Magpie Tours for the ultimate K2 climbing expedition. Experience the thrill of conquering the worlds second-highest peak with expert guides"
